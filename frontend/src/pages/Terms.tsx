  ...
  <Container sx={{ py: { xs: 8, md: 12 } }}>
    ...
    >
      ...
      <Typography variant="body1" sx={{ mb: 3, fontSize: '1.15rem', color: 'text.secondary' }}>
        Welcome to AssignmentAI. By accessing or using our platform, you acknowledge and agree to be
        legally bound by these Terms of Service ("Terms"). These Terms constitute a binding
        agreement between you (the "User") and AssignmentAI (the "Company"). Please read them
        carefully before using our services. If you do not agree to these Terms, you must not use
        AssignmentAI.
      </Typography>
      {[
        {
