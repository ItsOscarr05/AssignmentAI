    ...
    <Container sx={{ py: { xs: 8, md: 12 } }}>
      ...
      >
        ...
        <Typography variant="body1" sx={{ mb: 4, fontSize: '1.15rem', color: 'text.secondary' }}>
          ...
          learning. Our goal is to give students back their most valuable resource: time. With more
          time to dedicate to their interests and career goals, students can achieve greater
        ...
        <Typography variant="body1" sx={{ mb: 4, fontSize: '1.15rem', color: 'text.secondary' }}>
          ...
          students are often required to devote significant time and energy to subjects and concepts
          that do not align with their true passions or career goals.
          <br />
          <br />
          Frustrated by the disconnect between the promise of a personalized education and the
          reality of mandatory busy work, he set out to build a solution. AssignmentAI was born from
          the desire to help students reclaim their time and focus on what genuinely excites them.
          What started as a personal project quickly grew into a platform designed to empower
          students everywhere to pursue their interests, deepen their expertise, and make the most
          of their academic investment.
          <br />
          <br />
        ...
        <Typography variant="body1" sx={{ mb: 4, fontSize: '1.15rem', color: 'text.secondary' }}>
          We are committed to continuous improvement and innovation. Our team regularly updates the
          platform with new features and improvements based on user feedback. We maintain strict
          privacy and security standards to ensure that your academic work remains protected. Our
          goal is to be your trusted partner in academic success.
          <br />
          <br />
          ...
          to building trust with our users by being responsive, honest, and proactive in addressing
          concerns. AssignmentAI is more than a tool—it's a promise to support your academic journey
        ...
        <Typography variant="body1" sx={{ fontSize: '1.15rem', color: 'text.secondary' }}>
          ...
          our growing community of learners and educators who are embracing the future of education.
          <br />
          <br />
          We invite you to connect with us, share your experiences, and help shape the future of
          AssignmentAI. Participate in our community forums, attend our webinars, or contribute your
          ideas for new features. Together, we can create a smarter, more inclusive, and more
